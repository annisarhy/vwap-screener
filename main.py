...
def main():
    ...
    print(f" Min RR      : 1:2")
    print(f" 📦 Vol Spike : ≥ 30% above avg (20 candle)")
    print(f" 🔄 MSS       : Swing break (5 candle lookback)")
    print(f" 🕐 HTF Check : 1H VWAP alignment (soft)")
    print(f" 🛑 Dynamic SL: Trigger candle + 0.2% buffer")
    print(f" 💡 Trailing  : After TP1, trail at 50% risk")
